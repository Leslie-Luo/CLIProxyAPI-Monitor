...
export default function RecordsPage() {
  ...
  const dayPickerClassNames = useMemo(
    () => ({
      ...
      row: "w-full",
      cell: "p-0",
      day: "h-8 w-full text-sm text-slate-200 hover:bg-slate-800/70 rounded-none relative z-10",
      day_today: "text-indigo-300 font-semibold",
      day_selected: "!bg-indigo-500 !text-white font-semibold rounded-none",
      day_range_start: "!bg-indigo-500 !text-white font-semibold !rounded-l-lg",
      day_range_end: "!bg-indigo-500 !text-white font-semibold !rounded-r-lg",
      day_range_middle: "!bg-indigo-500/25 !text-indigo-100 rounded-none",
